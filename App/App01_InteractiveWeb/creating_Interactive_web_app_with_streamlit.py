...
#load the saved html files of the auto data analyzed files
		analNG = open("App/App01_InteractiveWeb/analysis_report_profilereport.html", 'r', encoding='utf-8')
		components.html(analNG.read(), height=8000, width=1000, scrolling=False)
with tab2:
		analNG = open("App/App01_InteractiveWeb/analysis_with_sweetviz.html", 'r', encoding='utf-8')
